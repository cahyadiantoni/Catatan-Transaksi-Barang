          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nosj" placeholder="Masukan nomor surat jalan...">
              </div>
              <div class="form-group">
                <label>Nomor Polisi Kendaraan</label>
                <input type="text" class="form-control" name="nopk" placeholder="Masukan nomor polisi kendaraan...">
              </div>
              <!-- select -->
              <div class="form-group">
                <label>Nama Supir</label>
                <select name="nama_supir" class="form-control">
                  <option disabled selected>Nama supir</option>
              ...
              <div class="form-group">
                ...
                <select name="nama_pengurus" id="nama_pengurus" class="form-control">
                  <option disabled selected>Nama pengurus</option>
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_pengurus2" id="nama_pengurus2" >
              </div>
              <div class="form-group">
                <label>ACT Nama Perusahaan</label>
                <input type="text" class="form-control" name="nama_perusahaan2" id="nama_perusahaan2" >
              </div>
              <div class="form-group">
